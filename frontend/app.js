/*
  I structured the app using a central state object to manage data and UI state.
  I used utility functions for date parsing, distance calculation, and median calculation.
  The app fetches data from a backend, applies filters, and renders tables, charts, and a map.
  I used Chart.js for visualizations and Leaflet for the map.
*/
...
// --- Utility Functions ---
// I created a function to parse date strings into Date objects.
function parseDate(dateString) {
  if (!dateString) return null;
  return new Date(dateString);
}

// I used the Haversine formula to calculate distances between pickup and dropoff locations.
...
// I added a utility to calculate the median of an array.
function median(arr) {
...
// --- DOM Elements ---
// I selected all the necessary DOM elements for manipulation.
...
// --- Filter Controls ---
// I selected all filter controls for event handling.
...
// --- Chart Elements ---
// I selected canvas elements for chart rendering.
...
// --- Map Element ---
// I selected the map container for Leaflet.
const mapDiv = document.getElementById("map");

// --- Fetch Data ---
// I created a function to fetch trip data from the backend.
...
// --- Filtering & Sorting ---
// I created a function to apply all filters and sorting to the data.
...
// I added a function to reset all filters.
...
// --- Table Rendering ---
// I created a function to render the trips table with pagination.
...
// --- Metrics Rendering ---
// I added a function to render summary metrics.
...
// --- Charts Rendering ---
// I created functions to render histograms and a donut chart using Chart.js.
...
// --- Map Rendering ---
// I used Leaflet to render a map with pickup locations.
function renderMap() {
  if (!state.map) {
...
// --- Pagination ---
// I added event listeners for pagination controls.
prevPageBtn.onclick = () => {
  if (state.page > 1) {
    state.page--;
    renderTable();
...
// --- Initial Load ---
// I initialized the app when the DOM is loaded.
